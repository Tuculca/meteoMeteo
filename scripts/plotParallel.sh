...
echo "End  : "$dateNew
echo " "
echo "python plotRainDiff.py ${addressWrfouts}/wrfout_d0x_${dateOld} ${addressWrfouts}/wrfout_d0x_${dateNew} ${addressWrfouts}/OPER/plots/Rain3h_d0x_"
echo " "
...
echo "End  : "$date2New
echo " "
echo "python plotCloudTot_OPER.py ${addressWrfouts}/wrfout_${domain}_${date2New} ${addressWrfouts}/OPER/plots/CloudTot_d0x_"
echo " "
...
echo " "
echo "python plotGeop_OPER.py ${addressWrfouts}/wrfout_d0x_${date2New} ${addressWrfouts}/OPER/plots/Clouds_d0x_"
echo " "
...
echo " "
echo "python plotTemperature_OPER.py ${addressWrfouts}/wrfout_d0x_${date2New} ${addressWrfouts}/OPER/plots/Temperature_d0x_"
echo " "
...
echo " "
echo "python plotWind_OPER.py ${addressWrfouts}/wrfout_d0x_${date2New} ${addressWrfouts}/OPER/plots/Wind_d0x_"
echo " "
...
echo " "
echo "python plotRH_OPER.py ${addressWrfouts}/wrfout_d0x_${date2New} ${addressWrfouts}/OPER/plots/RH_d0x_"
echo " "
